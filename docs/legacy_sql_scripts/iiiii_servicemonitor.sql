...
INSERT INTO Page (extension, title, url, permission, type) VALUES
	('itsmservicemonitor', 'Service Monitor', 'monitor/services', 'itsmmonitor-services', 'page'),
	('itsmservicemonitor', 'Service Monitor A.P.I.', 'monitor/services/api', 'itsmmonitor-services', 'page'),
	('itsmservicemonitor', 'Service Categories', 'monitor/services/categories', 'itsmmonitor-services-write', 'page'),
	('itsmservicemonitor', 'New Category', 'monitor/services/categories/new', 'itsmmonitor-services-write', 'page'),
	('itsmservicemonitor', 'Edit Category', 'monitor/services/categories/edit', 'itsmmonitor-services-write', 'page'),
	('itsmservicemonitor', 'Delete Category', 'monitor/services/categories/delete', 'itsmmonitor-services-write', 'page');
